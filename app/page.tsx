...
export default function Home() {
  ...
  return (
    ...
    <div className={`min-h-screen p-8 md:p-6 lg:p-8`}
    >
          ...
          <div className="inline-flex flex-col items-start gap-[19px] relative flex-[0_0_auto]">
            <div className="inline-flex items-start gap-[18px] relative flex-[0_0_auto]">
              <div className={`${isDarkMode ? "bg-black" : "bg-white"} relative w-[450px] h-[299px] rounded-[13.94px]`}>
                <Card className={`${isDarkMode ? "bg-black border-white" : "bg-white border-slate-300"} p-2 rounded-lg`}>
                  <div className={`mb-3 ${isDarkMode ? "text-white" : "text-black"}`}>Cloud</div>
                  <MuiLineChart className="w-full h-[150px] md:h-[200px] lg:h-[250px]" isDarkMode={isDarkMode} />
                </Card>
              </div>
              <div className={`${isDarkMode ? "bg-black" : "bg-white"} relative w-[450px] h-[299px] rounded-[13.94px]`}>
                <Card className={`${isDarkMode ? "bg-black border-white" : "bg-white border-slate-300"} p-2 rounded-lg`}>
                  <div className={`mb-3 ${isDarkMode ? "text-white" : "text-black"}`}>Solar Radiation</div>
                  <MuiLineChart className="w-full h-[150px] md:h-[200px] lg:h-[250px]" isDarkMode={isDarkMode} />
                </Card>
              </div>
              <div className={`${isDarkMode ? "bg-black" : "bg-white"} relative w-[450px] h-[299px] rounded-[13.94px]`}>
                <Card className={`${isDarkMode ? "bg-black border-white" : "bg-white border-slate-300"} p-2 rounded-lg`}>
                  <div className={`mb-3 ${isDarkMode ? "text-white" : "text-black"}`}>Power Generated</div>
                  <MuiLineChart className="w-full h-[150px] md:h-[200px] lg:h-[250px]" isDarkMode={isDarkMode} />
                </Card>
              </div>
            </div>
            <div className="inline-flex items-start gap-[18px] relative flex-[0_0_auto]">
              <div className={`${isDarkMode ? "bg-black" : "bg-white"} relative w-[450px] h-[299px] rounded-[13.94px]`}>
                <Card className={`${isDarkMode ? "bg-black border-white" : "bg-white border-slate-300"} p-2 rounded-lg`}>
                  <div className={`mb-3 ${isDarkMode ? "text-white" : "text-black"}`}>Net Demand</div>
                  <MuiLineChart className="w-full h-[150px] md:h-[200px] lg:h-[250px]" isDarkMode={isDarkMode} />
                </Card>
              </div>
              <div className={`${isDarkMode ? "bg-black" : "bg-white"} relative w-[450px] h-[299px] rounded-[13.94px]`}>
                <Card className={`${isDarkMode ? "bg-black border-white" : "bg-white border-slate-300"} p-2 rounded-lg`}>
                  <div className={`mb-3 ${isDarkMode ? "text-white" : "text-black"}`}>Deficit</div>
                  <MuiLineChart className="w-full h-[150px] md:h-[200px] lg:h-[250px]" isDarkMode={isDarkMode} />
                </Card>
              </div>
              <div className={`${isDarkMode ? "bg-black" : "bg-white"} relative w-[450px] h-[299px] rounded-[13.94px]`}>
                <Card className={`${isDarkMode ? "bg-black border-white" : "bg-white border-slate-300"} p-2 rounded-lg`}>
                  <div className={`mb-3 ${isDarkMode ? "text-white" : "text-black"}`}>Buying/Selling</div>
                  <MuiLineChart className="w-full h-[150px] md:h-[200px] lg:h-[250px]" isDarkMode={isDarkMode} />
                </Card>
              </div>
            </div>
...
function MuiLineChart({ className, isDarkMode }: { className: string; isDarkMode: boolean }) {
  ...
  const axisTickColor = isDarkMode ? 'white' : theme.palette.text.primary;
  const gridLineColor = isDarkMode ? 'gray' : theme.palette.text.primary;
